...
$arrayofparameters = array(
	'EASYINTERVENTIONMODELS_MYPARAM1'=>array('type'=>'string', 'css'=>'minwidth500' ,'enabled'=>1),
	'EASYINTERVENTIONMODELS_MYPARAM2'=>array('type'=>'textarea','enabled'=>1),
	//'EASYINTERVENTIONMODELS_MYPARAM3'=>array('type'=>'category:'.Categorie::TYPE_CUSTOMER, 'enabled'=>1),
	//'EASYINTERVENTIONMODELS_MYPARAM4'=>array('type'=>'emailtemplate:thirdparty', 'enabled'=>1),
	//'EASYINTERVENTIONMODELS_MYPARAM5'=>array('type'=>'yesno', 'enabled'=>1),
	//'EASYINTERVENTIONMODELS_MYPARAM5'=>array('type'=>'thirdparty_type', 'enabled'=>1),
	//'EASYINTERVENTIONMODELS_MYPARAM6'=>array('type'=>'securekey', 'enabled'=>1),
	//'EASYINTERVENTIONMODELS_MYPARAM7'=>array('type'=>'product', 'enabled'=>1),
);
...
print dol_get_fiche_head($head, 'settings', $langs->trans($page_name), -1, "easyinterventionmodels@easyinterventionmodels");

// Setup page goes here
echo '<span class="opacitymedium">'.$langs->trans("EasyInterventionModelsSetupPage").'</span><br><br>';
...
$moduledir = 'easyinterventionmodels';
$myTmpObjects = array();
					...
					while (($file = readdir($handle)) !== false) {
						if (strpos($file, 'mod_'.strtolower($myTmpObjectKey).'_') === 0 && substr($file, dol_strlen($file) - 3, 3) == 'php') {
							...
							if ($module->isEnabled()) {
								...
								$constforvar = 'EASYINTERVENTIONMODELS_'.strtoupper($myTmpObjectKey).'_ADDON';
